...
const ForgotPassword = ({ location }) => {
  const [infoForgotPassword, setInfoForgotPassword] = useState(INFO_FORGOT_PASSWORD);
      ...
      <LayoutOne >
        ...
        <div className="login-register-area pt-100 pb-100">
          <div className="container">
            <div className="row">
              {code && <PageCreateNewPassword code={code} infoCreateNewPassword={infoForgotPassword} setInfoCreateNewPassword={setInfoForgotPassword} />}
              {!code && <PageForgotPassword
                email={infoForgotPassword.email}
                setEmail={(value) => setInfoForgotPassword(prev => ({ ...prev, email: value }))} />}
